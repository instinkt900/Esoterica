...
|---|---|---|---|
| `Code/Scripts/NinjaGen/NinjaGen.py` | Substantial rewrite across P0.1–P0.10. Special case — see [01-UpstreamMerges.md](01-UpstreamMerges.md#special-case-codescriptsninjagenninjagenpy). The P0.1 slice (`.slnx` parsing) landed in PR #1 (2026-08-26); P0.2–P0.10 not started. | 0 | planned |
