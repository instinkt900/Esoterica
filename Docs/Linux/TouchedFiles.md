...
|---|---|---|---|
| `Code/Scripts/NinjaGen/NinjaGen.py` | Substantial rewrite. Special case — see [01-UpstreamMerges.md](01-UpstreamMerges.md#special-case-codescriptsninjagenninjagenpy). P0.1 (`.slnx` parsing) is the first slice, in flight on `linux/p0.1-slnx-parsing`. | 0 | in flight (P0.1) |
