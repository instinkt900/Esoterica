...
{
    struct EE_ENGINETOOLS_API EntityCollectionResourceDescriptor : public Resource::ResourceDescriptor
    {
        EE_REFLECT_TYPE( EntityCollectionResourceDescriptor );
    ...
    public:
        ...
        virtual ResourceTypeID GetCompiledResourceTypeID() const override { return EntityCollection::GetStaticResourceTypeID(); }
        virtual FileSystem::Extension GetExtension() const override final { return EntityCollection::GetStaticResourceTypeID().ToString(); }
        virtual char const* GetFriendlyName() const override final { return EntityCollection::s_friendlyName; }
    ...
    public:
        ...
        EntityCollection                    m_collection; // Serialized into the custom data of the descriptor
